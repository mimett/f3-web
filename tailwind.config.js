  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        legendary: "url('/assets/Icon/bg-legendary.png')",
        common: "url('/assets/Icon/bg-common.png')",
        uncommon: "url('/assets/Icon/bg-uncommon.png')",
        rare: "url('/assets/Icon/bg-rare.png')",
        epic: "url('/assets/Icon/bg-epic.png')",
      },
      animation: {
